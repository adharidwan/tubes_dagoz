...
bool ros2_socketcan_msgs__msg__fd_frame__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_socketcan_msgs.msg._fd_frame.FdFrame", full_classname_dest, 41) == 0);
  }
  ros2_socketcan_msgs__msg__FdFrame * ros_message = _ros_message;
  {  // header
...
PyObject * ros2_socketcan_msgs__msg__fd_frame__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_socketcan_msgs.msg._fd_frame");
