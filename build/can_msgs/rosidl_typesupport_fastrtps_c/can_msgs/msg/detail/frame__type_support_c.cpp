  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const can_msgs__msg__Frame * ros_message = static_cast<const can_msgs__msg__Frame *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_can_msgs__msg__Frame(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  can_msgs__msg__Frame * ros_message = static_cast<can_msgs__msg__Frame *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_can_msgs__msg__Frame(cdr, ros_message);
}
