...
#include "control/msg/detail/hardware_command__rosidl_typesupport_fastrtps_c.h"
...
using _HardwareCommand__ros_msg_type = control__msg__HardwareCommand;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_control
bool cdr_serialize_control__msg__HardwareCommand(
  const control__msg__HardwareCommand * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_control
bool cdr_deserialize_control__msg__HardwareCommand(
  eprosima::fastcdr::Cdr & cdr,
  control__msg__HardwareCommand * ros_message)
{
  // Field name: motor1
  {
    cdr >> ros_message->motor1;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_control
size_t get_serialized_size_control__msg__HardwareCommand(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_control
size_t max_serialized_size_control__msg__HardwareCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = control__msg__HardwareCommand;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_control
bool cdr_serialize_key_control__msg__HardwareCommand(
  const control__msg__HardwareCommand * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: motor1
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_control
size_t get_serialized_size_key_control__msg__HardwareCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _HardwareCommand__ros_msg_type * ros_message = static_cast<const _HardwareCommand__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_control
size_t max_serialized_size_key_control__msg__HardwareCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const control__msg__HardwareCommand * ros_message = static_cast<const control__msg__HardwareCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_control__msg__HardwareCommand(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  control__msg__HardwareCommand * ros_message = static_cast<control__msg__HardwareCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_control__msg__HardwareCommand(cdr, ros_message);
}

static uint32_t _HardwareCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_control__msg__HardwareCommand(
...
static size_t _HardwareCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_control__msg__HardwareCommand(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, control, msg, HardwareCommand)() {
