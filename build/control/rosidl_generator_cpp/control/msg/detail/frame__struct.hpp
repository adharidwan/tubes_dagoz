...
#ifndef CONTROL__MSG__DETAIL__FRAME__STRUCT_HPP_
#define CONTROL__MSG__DETAIL__FRAME__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__control__msg__Frame __attribute__((deprecated))
#else
# define DEPRECATED__control__msg__Frame __declspec(deprecated)
#endif
...
struct Frame_
{
  ...
  // pointer types
  using RawPtr =
    control::msg::Frame_<ContainerAllocator> *;
  using ConstRawPtr =
    const control::msg::Frame_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<control::msg::Frame_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<control::msg::Frame_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      control::msg::Frame_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<control::msg::Frame_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<control::msg::Frame_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<control::msg::Frame_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<control::msg::Frame_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__control__msg__Frame
    std::shared_ptr<control::msg::Frame_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__control__msg__Frame
    std::shared_ptr<control::msg::Frame_<ContainerAllocator> const>
...
using Frame =
  control::msg::Frame_<std::allocator<void>>;
...
#endif  // CONTROL__MSG__DETAIL__FRAME__STRUCT_HPP_
