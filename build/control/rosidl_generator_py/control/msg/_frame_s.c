...
bool control__msg__frame__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("control.msg._frame.Frame", full_classname_dest, 24) == 0);
  }
  control__msg__Frame * ros_message = _ros_message;
  {  // header
...
PyObject * control__msg__frame__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("control.msg._frame");
