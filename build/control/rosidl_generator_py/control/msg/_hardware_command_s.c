...
bool control__msg__hardware_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("control.msg._hardware_command.HardwareCommand", full_classname_dest, 45) == 0);
  }
  control__msg__HardwareCommand * ros_message = _ros_message;
  {  // motor1
...
PyObject * control__msg__hardware_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("control.msg._hardware_command");
