...
#include "control/msg/detail/frame__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = control::msg::Frame;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const control::msg::Frame *>(
    untyped_ros_message);
...
{
  return &control::msg::typesupport_fastrtps_cpp::_Frame__handle;
}
