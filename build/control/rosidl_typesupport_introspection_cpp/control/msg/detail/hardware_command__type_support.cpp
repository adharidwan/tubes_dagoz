...
{
  new (message_memory) control::msg::HardwareCommand(_init);
}

void HardwareCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<control::msg::HardwareCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HardwareCommand_message_member_array[4] = {
  {
    ...
    offsetof(control::msg::HardwareCommand, motor1),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control::msg::HardwareCommand, motor2),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control::msg::HardwareCommand, motor3),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control::msg::HardwareCommand, motor4),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HardwareCommand_message_members = {
  ...
  4,  // number of fields
  sizeof(control::msg::HardwareCommand),
...
{
  return &::control::msg::rosidl_typesupport_introspection_cpp::HardwareCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, control, msg, HardwareCommand)() {
  return &::control::msg::rosidl_typesupport_introspection_cpp::HardwareCommand_message_type_support_handle;
}
